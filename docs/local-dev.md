...
python tests\verify_week_07.py
python tests\verify_week_07_workspace_isolation.py
```

## Notes

* Mock mode is for infrastructure and workflow development, not final reasoning quality.
* Week 7 verification assumes PostgreSQL and Qdrant are reachable and that the development workspace already exists.
